...
const mockUsers = [
    { id: 1, name: 'NANDHAKISHORE', email: 'nandha06.kishore06@gmail.com', password: '123453355' },
    { id: 2, name: 'KISHORE', email: 'Boogie@gmail.com', password: '123453355' }
];
...
const mockDomains = {
    'web-dev': {
        ...
        icon: 'fa-code',
        members: [
            { id: 1, name: 'KISHORE', role: 'Student' },
            { id: 2, name: 'Sudhan', role: 'Instructor' }
        ],
        courses: [
